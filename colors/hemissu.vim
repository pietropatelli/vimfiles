...
" ----------------------------------------------------------
" NOTE: Modified by Pietro Patelli to fix an annoying issue (some words are highlighted in yellow when the cursor goes upwards)
